...
const strengthChart = new Chart(strengthCtx, {
    ...
    data: {
        ...
        datasets: [
            {
                label: 'Pre-Test',
                data: [pre_flexibilityValue, pre_enduranceValue, pre_strengthValue, pre_speedValue, pre_agilityValue],
            ...
            {
                label: 'Post-Test',
                data: [post_flexibilityValue, post_enduranceValue, post_strengthValue, post_speedValue, post_agilityValue],
